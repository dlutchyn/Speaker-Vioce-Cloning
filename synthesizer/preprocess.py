...
def preprocess_dataset(datasets_root: Path, out_dir: Path, n_processes: int,
    ...
    print("Metadata file: " + str(metadata_fpath))
    ...
    for book_dir in speaker_dir.glob("*"):
        ...
        if no_alignments:
            ...
            for extension in extensions:
                search_path = os.path.join(book_dir, extension)
                ...
                for wav_fpath in wav_fpaths:
                    ...
                    if '/home/dlutc/Documents/UCU/Real-Time-Voice-Cloning/dataset/uk_UK/by_book/male/obruchov/voly/wavs/voly_30_f000001.wav' == str(text_fpath):
                        continue
            ...
            try:
                ...
                with alignments_fpath.open("r", encoding="utf-8") as alignments_file: # no encoding
...
def create_embeddings(synthesizer_root: Path, encoder_model_fpath: Path, n_processes: int):
    ...
    with metadata_fpath.open("r", encoding="utf-8") as metadata_file: # no encoding
        metadata = [line.split("|") for line in metadata_file]
