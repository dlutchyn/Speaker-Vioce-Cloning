...
from encoder.config import librispeech_datasets, anglophone_nationalites, mailabs_datasets
...
def preprocess_mailabs(datasets_root: Path, out_dir: Path, skip_existing=False):
    for dataset_name in mailabs_datasets["train"]["other"]:
        dataset_root, logger = _init_preprocess_dataset(dataset_name, datasets_root, out_dir)
        if not dataset_root:
            return
			
        speaker_dirs = list(dataset_root.glob("male/*")) # add male
        print(speaker_dirs)
